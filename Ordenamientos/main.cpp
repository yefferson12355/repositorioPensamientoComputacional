...
int main()
{
    ...
    // Tamaño del array
    int size;
    cout <<RED<<char(197)<<"|                             MENU DE ORDENACIONES                         |"<<char(197)<<RESET<<endl;

    cout <<RED<< "Ingrese el tama"<<char(164)<<"o del array: "<<endl<<endl;
    cin >> size;
    ...
    int choice;
    bool ascending;
    cout << RED <<BG_YELLOW << "Seleccione el orden:"<<RESET<<endl;
    cout << "1. Ascendente\n2. Descendente\n";
    ...
    cout << left << setw(15) << "Bubble Sort" << " ==> ";;drawBar(grafico5);
    cout << left << setw(15) << "Quick Sort" << " ==> ";;drawBar(grafico6);
